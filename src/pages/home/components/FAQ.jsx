...
const FAQ = () => {
  ...
  return (
    <section className="py-24 bg-linear-to-br from-green-200 via-green-100 to-green-50">
      <div className="container mx-auto px-6">
        ...
        >
                        ...
                        {faq.bullets && (
                          <ul className="mt-3 space-y-2">
                            {faq.bullets.map((bullet, bulletIndex) => (
                              <li key={bulletIndex} className="text-gray-600 leading-relaxed flex items-start">
          ...
          <div className="text-center mt-8">
            <Link to="/faq">
              <motion.button
                className="px-10 py-4 rounded-full bg-gray-900 text-white font-bold hover:bg-gray-800 transition-colors duration-300 shadow-lg"
